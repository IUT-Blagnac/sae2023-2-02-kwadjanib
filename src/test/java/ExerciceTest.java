...
public class ExerciceTest {
    ...
    public void testSolution() {
        ...
        public void testSolution5() {
            ...
            assertEquals(List.of("Il ","fait", "beau", "aujourd","hui"), Exercice.solution("Il fait beau aujourd'hui", List.of('z', 'x', 'y')));
        }

        @Test
        public void testSolution6() {
            // Chaine avec des caractères dupliqués dans la phrase
            assertEquals(List.of("it", "fait", "fa", "fat", "fait", "fait", "fait", "fait"), Exercice.solution("fait fa it fat fait fait fait fait", List.of('d', 'u', 'p', 'l', 'i', 'q', 'e', 's')));
        }
